const PlacementHeadV2 = require("../models/placementHeadV2");

exports.getPlacementHeadV2 = async (req, res) => {
    try {
        const data = await PlacementHeadV2.findOne();
        if (!data) {
...
exports.updatePlacementHeadV2 = async (req, res) => {
    try {
        let data = await PlacementHeadV2.findOne();
        if (data) {
